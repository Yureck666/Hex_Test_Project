...
namespace Hex.Core
{
    public class GridManager : MonoBehaviour
    {
        ...
        public HexCell GetCell([Bridge.Ref] HexCoordinates coords)
        {
            return _cells.GetValueOrDefault(coords);
        }

        public bool IsValidCell([Bridge.Ref] HexCoordinates coords)
        {
        ...
        public HexCell GetCellAtWorldPosition([Bridge.Ref] Vector3 worldPos)
        {
